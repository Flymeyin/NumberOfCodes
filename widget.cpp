...
void Widget::initForm()
{
    ...
    QList<int> columWidth;
    columWidth <<130<<50<<70<<80<<70<<70<<70<<150;
...
void Widget::NumberOfCodes(const QString &filePath)
{
    QDir dir(filePath);
...
void Widget::on_btnOpenPath_clicked()
{
